                        ...
                        <div class="card-body">
                            <form class="form-horizontal form-material mx-2" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" value="{{ Auth::user()->pharmacy->opens_at }}" name="open_at"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" value="{{ Auth::user()->pharmacy->close_at }}" name="close_at"
                                            class="form-control ps-0 form-control-line">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <select name="active" id=""  class="form-control">
                                            <option  value="{{ Auth::user()->pharmacy->active }}">
                                                {{ Auth::user()->pharmacy->active ? 'تعمل' : 'متوقفة' }}
                                            </option>
                                            <option value="true">
                                                تعمل
                                            </option>
